...
public class NumbersListResponseTest {

    @Test
    public void assertAccessors() throws Exception {
        assertGettersAndSetters(new NumbersListResponse());
    }

    @Test
    public void testToString() {
        assertToString(new NumbersListResponse(ImmutableList.of(number(numberDto())), new Pagination(50, null)));
    }
}
